 ...
 * point, since every warehouse insert goes through [org.hikyaku.mobile.warehouse.WarehouseRepository]
 * straight to `public.warehouse` via PostgREST. This only decides whether those flows offer "add a
 * new warehouse" — keep it in step with that migration's `v_limit`.
 */
