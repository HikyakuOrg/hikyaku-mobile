 ...
 *
 * False where there is no camera pipeline and no ML Kit, so the add-vehicle form hides the Scan
 * affordance entirely and leaves the VIN as plain text entry. Mirrors
